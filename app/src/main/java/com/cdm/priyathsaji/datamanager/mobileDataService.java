...
public class mobileDataService extends Service {
    ...
    static long lUploaded ;
    static long lDownloaded ;
    ...
    @Nullable
        ...
        public void updatemdpData(){
            ...
            if(refreshed){
                Intent intent = new Intent(this,mdRefresh.class);
                stopService(intent);
        ...
        void updateWifiNotification() {
            ...
            if(mdnData < 1024){
                temp1 = (int)(mdnData/1);
                temp2 = (int)(mdnData/0.01);
                temp1 = temp2 - (temp1*100);
                k1 = 1;
                b1=0;
            } else if (mdnData > 1073741824){
                temp1 = (int)(mdnData/1073741824);
                temp2 = (int)(mdnData/10737418.24);
                temp1 = temp2 - (temp1*100);
                k1 = 1073741824;
                b1=3;
            } else if (mdnData > (1048576)) {
                temp1 = (int)(mdnData/1048576);
                temp2 = (int)(mdnData/10485.76);
                temp1 = temp2 - (temp1*100);
                k1 =  1048576;
                b1=2;
            } else if (mdnData > 1024) {
                temp1 = (int)(mdnData/1024);
                temp2 = (int)(mdnData/10.24);
                temp1 = temp2 - (temp1*100);
                k1 = 1024;
                b1=1;
            }
            ...
            if (b == 0) {
                ...
                float temp = (int) mdSpeed/1048576;
                mbps = (int)temp;
                if(mbps > 9)
                    mbps = 9;
                kbps = (int)(mdSpeed/104857.6);
                kbps = kbps - (mbps*10);
                flag = 1;
            ...
            Intent intentp = new Intent(this,mdRefresh.class);
